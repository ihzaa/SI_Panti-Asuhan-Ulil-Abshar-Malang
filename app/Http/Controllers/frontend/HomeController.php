...
class HomeController extends Controller
{
    ...
    public function donation(Request $request)
    {
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_URL => "https://api.callmebot.com/whatsapp.php?phone=$telp->no_telp&text=Halo%20Bossss%20ada%20donasi%20masuk%20dari%20" . $request->email . "%20silahkan%20periksa%20mobile%20banking&apikey=$telp->key",
