    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        $('#tahun1').on('change', function() {
            ...
            if (val != "xx") {
                ...
                let download_tahun_url = "{{route('all_user_downlaod_Pengeluaran_tahun',['_tahunnn_'])}}";
                download_tahun_url = download_tahun_url.replace('_tahunnn_', val);
        ...
        $('#bulan1').on('change', function() {
            ...
            let val = $('#bulan1').val();
            if (val != "xx") {
                let url_bln = "{{route('all_user_downlaod_Pengeluaran_bulan',['month'=>'__bulan','year'=>'_tahunnn_'])}}";
                url_bln = url_bln.replace('__bulan', val);
                url_bln = url_bln.replace('_tahunnn_', year);
